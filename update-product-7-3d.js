...
async function updateProduct7() {
  ...
  try {
    ...
    // Update product ID 7 with 3D model URL
    const [result] = await connection.execute(
      'UPDATE products SET model_3d_url = ?, model_3d_filename = ? WHERE id = 7',
      ['/uploads/3d-models/3d-model-1757481693733-zuyxfiand0s.glb', '3d-model-1757481693733-zuyxfiand0s.glb']
    );
