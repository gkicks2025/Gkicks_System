        ...
        <div className="flex justify-between items-center h-16">
            ...
            {navigationItems.map((item) => (
              <Link
                ...
                className={`flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  item.active ? "bg-yellow-400/10 text-yellow-400" : "text-gray-300 hover:text-white hover:bg-gray-800"
                }`}
              >
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              size="sm"
              asChild
              className="hidden sm:flex bg-transparent border-gray-700 text-gray-300 hover:text-white hover:bg-gray-800"
            >
              <Link href="/">
