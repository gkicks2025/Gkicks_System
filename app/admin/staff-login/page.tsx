...
export default function StaffLogin() {
  ...
  const fillDemoCredentials = (role: "staff" | "cashier") => {
    if (role === "staff") {
      setEmail("staff@gkicks.com")
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="w-20 h-20 bg-yellow-400 rounded-xl flex items-center justify-center p-2">
              <Image
                src="/images/gkicks-admin-logo-full.jpeg"
                alt="GKicks Staff"
                width={64}
                height={64}
          ...
          <h2 className="text-3xl font-bold text-yellow-400">GKicks Staff Portal</h2>
          <p className="mt-2 text-yellow-200">Sign in to your staff account</p>
        </div>
            ...
            <Tabs defaultValue="staff" className="w-full">
              ...
              <TabsContent value="staff" className="space-y-4">
                <div className="p-4 bg-blue-400 bg-opacity-10 rounded-lg border border-blue-400 border-opacity-30">
                  <div className="flex items-center justify-between mb-3">
                    <Badge className="bg-yellow-200 text-black font-semibold">Staff Member</Badge>
                    <User className="h-5 w-5 text-blue-400" />
                  </div>
                  <div className="space-y-2 text-sm">
                    <p className="text-yellow-100">
                      <strong>Email:</strong> staff@gkicks.com
                    </p>
                    <p className="text-yellow-100">
                  ...
                  <div className="mt-3 pt-3 border-t border-blue-400 border-opacity-30">
                    ...
                    <p className="text-xs text-blue-300">Staff can only view and manage customer orders</p>
                  </div>
                  <Button
              ...
              <TabsContent value="cashier" className="space-y-4">
                <div className="p-4 bg-green-400 bg-opacity-10 rounded-lg border border-green-400 border-opacity-30">
                  <div className="flex items-center justify-between mb-3">
                    <Badge className="bg-yellow-300 text-black font-semibold">Cashier</Badge>
                  ...
                  <div className="mt-3 pt-3 border-t border-green-400 border-opacity-30">
                    ...
                    <p className="text-xs text-green-300">Cashier can process sales and manage inventory deductions</p>
                  </div>
                  <Button
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardContent className="pt-6">
            <div className="text-center space-y-3">
              <p className="text-yellow-200 text-sm">Need administrator access?</p>
              <Button
                variant="outline"
