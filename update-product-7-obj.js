...
async function updateProduct7WithOBJ() {
  let connection;
  ...
  try {
    ...
    // Update product ID 7 with existing OBJ file that has materials
    const [result] = await connection.execute(
      'UPDATE products SET model_3d_url = ?, model_3d_filename = ? WHERE id = 7',
      ['/uploads/3d-models/3d-model-1755411424493-95utc4wf0kg.obj', '3d-model-1755411424493-95utc4wf0kg.obj']
    );
    
    console.log('✅ Updated product 7 with OBJ file that has materials');
